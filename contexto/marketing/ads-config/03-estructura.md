...
- ✅ **Corregido el 02/08/2026:** `05-google-ads-operacion.md`, `09-automatizaciones.md` y `13-modo-experto-ads.md` ya no listan `form_submit_success` como primaria. La única primaria es `contact_whatsapp` (ADR-019).
