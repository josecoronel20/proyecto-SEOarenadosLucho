...
Anuncios (RSA) — mensajes permitidos: superficie lista para pintar/revestir · ~100 m²/día · 2 equipos propios · coordinación en obra · contención de polvo · visita y presupuesto sin costo. **PROHIBIDO: Sa3, ISO 8501, metal blanco, granallado.** Extensiones: sitelinks (/servicios, /casos-de-exito, /preguntas-frecuentes, /contacto), texto destacado, ubicación (cuando exista GBP).
