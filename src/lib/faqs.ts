...
export const faqs: Faq[] = [
  ...
  { question: "¿Hacen piletas? ¿La pintan ustedes también?", answer: "Sí, arenamos piletas de hormigón para sacarles toda la pintura vieja y dejarlas listas para repintar o revestir. El pintado o el revestimiento final no lo hacemos nosotros: te la entregamos preparada." },
