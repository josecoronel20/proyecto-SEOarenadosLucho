...
export function ProcessSection() {
  const processSteps = [
    ...
    },
    {
      step: "02",
      title: "Planificación",
      description: "Desarrollamos un plan específico para tu proyecto de arenado."
    },
    {
      step: "03",
      title: "Ejecución",
      description: "Realizamos el servicio de arenado con la máxima calidad y profesionalismo."
    },
    {
      step: "04",
      title: "Entrega",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 id="process-heading" className="text-3xl font-bold mb-4">
            Proceso de Ejecución en Arenado - 20+ Años en Pilar y Zona Norte
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6" role="list" aria-label="Proceso de ejecución de arenado">
