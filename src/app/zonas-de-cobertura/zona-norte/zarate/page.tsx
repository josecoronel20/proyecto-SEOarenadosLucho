  ...
  const zarateAdvantages = [
    {
      ...
      description: "Especializados en servicios para hogares y familias en Zárate, con atención personalizada y horarios flexibles."
    },
    {
      icon: <Building2 className="h-6 w-6" />,
      title: "Servicio Comercial",
      description: "Atendemos comercios, oficinas y establecimientos comerciales en Zárate con técnicas adaptadas a cada necesidad."
    },
    {
      icon: <Target className="h-6 w-6" />,
      title: "Precisión Garantizada",
      description: "Servicio especializado con precisión garantizada, técnicas suaves y atención personalizada que respeta el entorno residencial."
    }
  ]

  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Zonas de cobertura', href: '/zonas-de-cobertura' }, { label: 'Zona Norte', href: '/zonas-de-cobertura/zona-norte' }, { label: 'Zárate' }]} />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-cyan-100 text-cyan-800 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              Servicios de Arenado en Zárate
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Arenado en <span className="text-cyan-600">Zárate</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Servicio completo de arenado móvil en Zárate. 
              Especialistas en piletas, industrial, barcos, vehículos, piezas metálicas, muebles y fachadas con precisión garantizada.
            </p>
            <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground mb-8">
              <div className="flex items-center">
                <Home className="h-4 w-4 mr-2 text-cyan-600" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">¿Por qué elegirnos en Zárate?</h2>
              <p className="text-lg text-muted-foreground">
                Atención personalizada para hogares y comercios en Zárate
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {zarateAdvantages.map((advantage, index) => (
            ...
            <div className="mb-16">
              <Card className="border-cyan-200 bg-gradient-to-r from-cyan-50 to-cyan-100">
                <CardHeader>
                  <CardTitle className="text-cyan-800">Información Específica para Zárate</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="font-semibold text-cyan-700 mb-3">Zonas de Servicio</h4>
                      <ul className="space-y-2 text-sm text-cyan-600">
                        <li>• Centro de Zárate - Comercios y oficinas</li>
                    ...
                    <div>
                      <h4 className="font-semibold text-cyan-700 mb-3">Horarios Flexibles</h4>
                      <ul className="space-y-2 text-sm text-cyan-600">
            ...
            {/* Testimonials */}
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Testimonios de Clientes en Zárate</h2>
              <p className="text-lg text-muted-foreground">
                Experiencias de nuestros clientes en Zárate
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <Card className="border-cyan-200 bg-cyan-50">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-cyan-800 mb-4">
                    "Excelente servicio en mi casa en Zárate. Arenaron la pileta 
              ...
              <Card className="border-cyan-200 bg-cyan-50">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-cyan-800 mb-4">
                    "Contraté el servicio para mi comercio en el centro de Zárate. 
                    Arenaron la fachada y quedó impecable. 
                    Muy recomendables para establecimientos comerciales."
                  </p>
                  <div className="text-sm font-semibold text-cyan-700">
                    - Sr. Carlos Mendoza, Centro de Zárate
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center">
              <Card className="max-w-2xl mx-auto border-cyan-200 bg-gradient-to-br from-cyan-50 to-cyan-100">
                <CardContent className="pt-8 pb-8">
                  <h3 className="text-2xl font-bold mb-4">¿Necesitas servicio en Zárate?</h3>
