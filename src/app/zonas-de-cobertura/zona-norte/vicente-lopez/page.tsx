...
export default function VicenteLopezPage() {
  const vicenteLopezServices = [
    {
      id: "arenado-piletas-vicente-lopez",
      title: "Arenado de Piletas en Vicente López",
      description: "Limpieza profunda y preparación para pintura de piletas en Vicente López",
      features: ["Piletas residenciales", "Piletas comerciales", "Preparación epoxi", "Limpieza profunda"],
      href: "/servicios/arenado-de-piletas"
    },
    {
      id: "arenado-industrial-vicente-lopez", 
      title: "Arenado Industrial en Vicente López",
      description: "Servicio industrial para estructuras metálicas y maquinaria en Vicente López",
    ...
    {
      id: "arenado-barcos-vicente-lopez",
      title: "Arenado de Barcos en Vicente López", 
      description: "Mantenimiento naval profesional para embarcaciones en Vicente López",
    ...
    {
      id: "arenado-vehiculos-vicente-lopez",
      title: "Arenado de Vehículos en Vicente López", 
      description: "Preparación para pintura automotriz en Vicente López",
      features: ["Vehículos familiares", "Vehículos comerciales", "Técnicas suaves", "Preservación"],
      href: "/servicios/arenado-de-vehiculos"
    },
    {
      id: "arenado-piezas-metalicas-vicente-lopez",
      title: "Arenado de Piezas Metálicas en Vicente López", 
      description: "Tratamiento de piezas pequeñas con precisión en Vicente López",
    ...
    {
      id: "arenado-muebles-vicente-lopez",
      title: "Arenado de Muebles en Vicente López", 
      description: "Restauración de muebles de madera y metal en Vicente López",
      features: ["Muebles de madera", "Restauración", "Despintado fino", "Preservación"],
      href: "/servicios/arenado-de-muebles"
    },
    {
      id: "arenado-fachadas-vicente-lopez", 
      title: "Arenado de Fachadas en Vicente López",
      description: "Limpieza de edificios residenciales y comerciales en Vicente López",
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Services in Vicente López */}
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Todos los Servicios en Vicente López</h2>
              <p className="text-lg text-muted-foreground">
                Servicios completos de arenado para hogares y comercios en Vicente López
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
              {vicenteLopezServices.map((service) => (
                <Card key={service.id} className="hover:shadow-lg transition-shadow border-amber-200">
                  <CardHeader>
