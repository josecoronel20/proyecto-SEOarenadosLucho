        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h3 id="services-heading" className="text-2xl font-bold mb-4">
              Servicios Disponibles en Zona Oeste
            </h3>
            <p className="text-muted-foreground mb-8">
              Todos nuestros servicios de arenado están disponibles en esta zona
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12" role="list" aria-label="Servicios de arenado disponibles">
