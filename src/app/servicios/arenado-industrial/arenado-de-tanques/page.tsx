...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-tanques")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-tanques")
  }
...
export default function ArenadoTanquesPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de tanques' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-tanque-tigre.webp"
        heroImageAlt="Arenado profesional de tanque en Tigre"
      />
      <BenefitsSection
