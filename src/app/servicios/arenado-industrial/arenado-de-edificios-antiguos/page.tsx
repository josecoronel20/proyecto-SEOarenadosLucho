...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-edificios-antiguos")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-edificios-antiguos")
  }
...
export default function ArenadoEdificiosAntiguosPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de edificios antiguos' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-edificio-palermo.png"
        heroImageAlt="Arenado profesional de edificio antiguo en Palermo"
      />
      <BenefitsSection
