...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-en-fabrica")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-en-fabrica")
  }
...
export default function ArenadoEnFabricaPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado en fábrica' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-fabrica-pilar.jpg"
        heroImageAlt="Arenado profesional en fábrica en Pilar"
      />
      <BenefitsSection
