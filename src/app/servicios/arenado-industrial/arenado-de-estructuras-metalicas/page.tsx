...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-estructuras-metalicas")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-estructuras-metalicas")
  }
...
export default function ArenadoEstructurasMetalicasPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de estructuras metálicas' }]} />
