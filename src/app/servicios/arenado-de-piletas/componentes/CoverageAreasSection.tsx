  ...
  const zones = [
    {
      ...
      description: "Arenado de piletas en Zona Norte"
    },
    {
      name: "Zona Oeste",
      href: "/zonas-de-cobertura/zona-oeste",
      description: "Arenado de piletas en Zona Oeste"
    },
    {
      name: "CABA",
      href: "/zonas-de-cobertura/caba",
      description: "Arenado de piletas en CABA"
    }
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Servicio profesional de arenado de piletas en toda la región metropolitana de Buenos Aires.
          </p>
        </div>
