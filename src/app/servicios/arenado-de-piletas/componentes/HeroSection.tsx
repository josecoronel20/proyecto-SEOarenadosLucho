  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 md:py-24">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/servicios/servicio-arenado-pileta-pilar.png"
          alt="Arenado profesional de pileta"
          fill
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-8 font-medium">
                Restaurá tu pileta descascarada con pintura vieja o sarro. Dejala lista para el verano.
              </p>
            ...
            <div className="relative h-96 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/servicios/servicio-arenado-pileta-pilar.png"
                alt="Arenado profesional de pileta - Antes y después"
                fill
