  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-16 md:py-24">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/servicios/servicio-arenado-superficie-madera-pilar.png"
          alt="Arenado profesional de madera"
          fill
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-8 font-medium">
                Quitá la pintura vieja de tus muebles y superficies de madera. Dejalos como nuevos sin dañar la madera.
              </p>
            ...
            <div className="relative h-96 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/servicios/servicio-arenado-superficie-madera-pilar.png"
                alt="Arenado profesional de madera - Muebles y superficies"
                fill
