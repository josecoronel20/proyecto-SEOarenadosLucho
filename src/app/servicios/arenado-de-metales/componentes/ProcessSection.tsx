...
const steps = [
  {
    ...
    description: "Realizamos una evaluación del trabajo mediante visita técnica o según medidas y fotos que nos envíes de tus piezas.",
  },
  {
    number: "2",
    icon: Calendar,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center text-gray-900">
            Proceso de arenado de metales
          </h2>
          <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            Proceso simple y profesional para restaurar tus piezas metálicas.
          </p>
