...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-pisos")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-pisos")
  }
...
export default function ArenadoPisosPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de pisos' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-piso-san-isidro.png"
        heroImageAlt="Arenado profesional de piso en San Isidro"
      />
      <BenefitsSection
