...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-fachadas")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-fachadas")
  }
...
export default function ArenadoFachadasDomiciliariasPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-fachada-domiciliaria-san-fernando.png"
        heroImageAlt="Arenado profesional de fachada domiciliaria en San Fernando"
      />
      <BenefitsSection
