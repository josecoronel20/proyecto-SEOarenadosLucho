...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-camiones")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-camiones")
  }
...
export default function ArenadoCamionesPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de camiones' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-camion-hurlingam.png"
        heroImageAlt="Arenado profesional de camión en Hurlingham"
      />
      <BenefitsSection
