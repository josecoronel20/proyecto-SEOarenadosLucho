...
function getServiceContent() {
  const service = servicesData.services.find(s => s.id === "arenado-autos")
  if (!service?.pageContent) {
    throw new Error("Service content not found for arenado-autos")
  }
...
export default function ArenadoAutosPage() {
  ...
  return (
    <div className="min-h-screen">
      <Breadcrumbs segments={[{ label: 'Servicios', href: '/servicios' }, { label: 'Arenado de autos' }]} />
      ...
      <HeroSection
        ...
        heroImage="/images/servicios/servicio-arenado-auto-san-fernando.png"
        heroImageAlt="Arenado profesional de auto en San Fernando"
      />
      <BenefitsSection
