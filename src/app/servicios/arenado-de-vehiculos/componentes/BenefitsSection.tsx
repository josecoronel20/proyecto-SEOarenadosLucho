...
const benefits = [
  {
    icon: Shield,
    title: "Quita óxido y pintura vieja",
    description:
  ...
  },
  {
    ...
    description:
      "Proceso rápido que evita días de trabajo manual con lija o químicos. Tu vehículo listo en menos tiempo.",
  },
  {
    icon: PaintBucket,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center text-gray-900">
            Beneficios del arenado automotriz
          </h2>
          <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            Solución profesional para restaurar autos, camiones, barcos y chasis.
          </p>
