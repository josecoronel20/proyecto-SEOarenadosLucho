...
export function ReviewsSection() {
  ...
  const reviewsSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Arenados Lucho",
    "description": "Servicio profesional de arenado de vehículos en Pilar, Zona Norte y Buenos Aires",
    "aggregateRating": {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Reseñas de Nuestros Clientes - Arenado de Vehículos en Zona Norte
            </h2>
            <p className="text-muted-foreground max-w-3xl mx-auto">
              La satisfacción de nuestros clientes es nuestra mayor recompensa. 
              Conocé las experiencias reales de quienes confiaron en nuestro servicio de arenado de vehículos 
          ...
          <div className="text-center">
            <div className="bg-white rounded-lg shadow-md p-8 max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Unite a más de 100 propietarios de vehículos que ya renovaron su auto o camioneta con nuestro servicio profesional de arenado.
              </p>
              <a
                href="https://wa.me/5491123787750?text=Hola,%20quiero%20contratar%20el%20servicio%20de%20arenado%20de%20vehiculo"
