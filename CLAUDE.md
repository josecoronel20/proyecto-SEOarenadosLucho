...
- **El número de WhatsApp NUNCA se escribe contiguo en el código** (anti-scraping): se arma partido en 2 strings en runtime (`"5491123" + "787750"`) y se abre con `window.open`. Tampoco va en el JSON-LD (`telephone`) ni como texto en el sitio.
