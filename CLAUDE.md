...
- **Google Ads — las 3 campañas ACTIVAS desde el 20/08/2026.** `AR-Search-Obra-Industrial` (3.000/día) · `AR-Search-Piletas` (**1.600/día** desde el 21/09/2026, subido de 1.250) · `AR-Search-General-Marca` (750/día). **La medición está verificada de punta a punta**: `contact_whatsapp` registra en la columna "Conversiones" de Ads (chequeo C3 aprobado el 20/08). Corriendo: el guardián de presupuesto (06, tope **ARS 300.000/mes**) y los 3 scripts de lectura (02/03/04). El **autopilot (05) sigue SIN instalar** — ahora sí se cumplen sus dos condiciones (conversiones fluyendo + URLs en 200), pero es una decisión explícita del dueño que sigue sin tomarse. ✅ **El congelamiento venció el 03/09/2026 y se levantó.** **Estado al 21/09: CPA base real de la cuenta = 1.970** (54 conversiones en 5 semanas); pausadas `sandblasteo`, `sandblasting` y `restaurar piscina/pileta`; `ag_pileta-sin-jerga` pausado el 14/09. Sigue vigente la regla de fondo: **un cambio estructural por vez**, con 1–2 semanas de datos antes del siguiente. Estado real siempre en `marketing/09-automatizaciones.md` y `marketing/08-bitacora.md`. Política de scripts en `marketing/06-google-ads-scripts.md`.
